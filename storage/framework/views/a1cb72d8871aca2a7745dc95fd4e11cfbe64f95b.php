...
<head>
  ...
  <!-- line-awesome -->
  <link href= "<?php echo e(asset('assets/fonts/line-awesome/1.3.0/css/line-awesome.min.css')); ?>"rel="stylesheet">
  <!-- bootstrap-select -->
  ...
  <!-- daterangepicker -->
  <link href="<?php echo e(asset('developer_assets/css/daterangepicker.css')); ?>" rel="stylesheet">
  <!-- select2 -->
  ...
  <link href="<?php echo e(asset('assets/css/jquery.fancybox.min.css')); ?>" rel="stylesheet">
    <!-- filepond -->
    <link  href="<?php echo e(asset('developer_assets/css/filepond/filepond-plugin-image-preview.min.css')); ?>" rel='stylesheet'>
  <link  href="<?php echo e(asset('developer_assets/css/filepond/filepond.min.css')); ?>" rel='stylesheet'>
  <link  href="<?php echo e(asset('developer_assets/css/filepond/filepond-plugin-file-poster.css')); ?>" rel='stylesheet'>
  <link href="https://unpkg.com/filepond/dist/filepond.css" rel="stylesheet" />
  <!-- e-drop -->
  <link href="<?php echo e(asset('assets/css/e-drop.min.css')); ?>" rel="stylesheet">
  <!--for developers-->
  <link rel="stylesheet" href="<?php echo e(asset('assets/css/developers.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('developer_assets/css/jquery.dataTables.min.css')); ?>">
  <!-- Google fonts -->
  ...
  <!-- Favicons -->
  <link rel="apple-touch-icon" href="<?php echo e(asset('assets/favicons/apple-touch-icon.png')); ?>" sizes="180x180">
  <link rel="icon" href="<?php echo e(asset('assets/favicons/favicon-32x32.png')); ?>" sizes="32x32" type="image/png">
  <link rel="icon" href="<?php echo e(asset('assets/favicons/favicon-16x16.png')); ?>" sizes="16x16" type="image/png">
  <link rel="mask-icon" href="<?php echo e(asset('assets/favicons/favicon-safari-pinned-tab.svg')); ?>" color="#000">
...
<body class="bg-offwhite <?php echo e($class_name); ?>">
                    ...
                    <div class="header-controls d-flex align-items-center ml-auto">
                      <div class="position-relative notification-control mr-3">
                        ...
                        <div class="user-control position-relative">
                            ...
                            data-offset="-175,10"
                            aria-haspopup="true">
                                <img src="<?php echo e(asset('assets/images/users/1.jpg')); ?>" alt="user" class="rounded-circle border cursor-pointer">
                            </div>
    ...
    <div id="sidebar" class="sidebar-wrap shadow-x-1">
       <div class="inner py-3">
            <div class="brand d-flex align-items-center justify-content-between p-3">
                <a href="/view/home" class="flex-shrink-0"><img src="<?php echo e(asset('developer_assets/images/movers_logo.jpg')); ?>" width="90" alt="logo"></a>
...
================================================== -->
  ...
  <script src="<?php echo e(asset('assets/js/custom-file-input.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/device.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/resize.min.js')); ?>"></script>
  <!-- <script src="assets/js/nav.js"></script> -->
  <script src="<?php echo e(asset('assets/js/jquery.scrollbar.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/jquery.ui.totop.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/wow.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/loader.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/progressively.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/magnific-popup.js')); ?>"></script>
  <script src="<?php echo e(asset('developer_assets/js/datepicker/moment.min.js')); ?>"></script>
  <script src="<?php echo e(asset('developer_assets/js/datepicker/daterangepicker.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('assets/js/notify/notify.js')); ?>"></script>
  <script src="<?php echo e(asset('developer_assets/js/chart/chart.min.js')); ?>"></script>
  <!-- <script src='assets/js/filepond/filepond-plugin-file-encode.min.js'></script>
    ...
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-file-encode.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-file-validate-type.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-image-exif-orientation.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-image-crop.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-image-resize.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-image-transform.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-image-preview.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond.min.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-file-validate-size.js')); ?>"></script>
    <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-plugin-file-poster.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('developer_assets/js/filepond/filepond-custom.js')); ?>"></script> -->

  <!-- <script src="assets/js/chart/chart-utils.js"></script> -->
  <!-- <script src="<?php echo e(asset('developer_assets/js/chart/chart-custom.js')); ?>"></script> -->
  <!-- <script src="<?php echo e(asset('developer_assets/js/chart/trip.js')); ?>"></script> -->
  <script src="<?php echo e(asset('developer_assets/js/jquery.dataTables.min.js')); ?>"></script>

  <!-- <script src="<?php echo e(asset('developer_assets/js/chart/chart-bookings.js')); ?>"></script> -->
  <script src="<?php echo e(asset('developer_assets/js/chart/chart-user.js')); ?>"></script>
  <script src="<?php echo e(asset('developer_assets/js/chart/driver-chart.js')); ?>"></script>
  <script src="<?php echo e(asset('developer_assets/js/chart/driver-pie-chart.js')); ?>"></script>
  <script src="<?php echo e(asset('assets/js/jquery-browserdetect.js')); ?>"></script>
...
</html><?php /**PATH /home/li14/projects/movers/resources/views/layouts/app.blade.php ENDPATH**/ ?>