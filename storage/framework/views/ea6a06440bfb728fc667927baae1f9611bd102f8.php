...
<head>
  ...
  <title>Page not found - e dRop</title>
  <!-- Bootstrap -->
...
<body class="page-error d-flex flex-column align-items-center justify-content-center full-screen bg-offwhite">
   ...
   <div class="wrapper">
        <div class="container">
            <div class="mb-3">
                <span class="h1 m-0 fw-bold text-primary">403</span>
            </div>
            <h1 class="h4">Access Denied</h1>
            <p>The page you're looking for doesn't exist or an other error occurred.<br>
                Go back, or head over to <a href="/view/home">Home</a> to choose a new direction.</p>
...
</html><?php /**PATH /home/li14/projects/movers/resources/views/auth/access_denied.blade.php ENDPATH**/ ?>