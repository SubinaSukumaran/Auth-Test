                    ...
                    <div class="card card-login border-0 shadow p-4 p-xl-5 radius-22 h-100">
                        <div class="mb-3 text-center">
                            <figure class="brand mb-4 mx-auto">
                                <img src="{{asset('developer_assets/images/movers_logo.jpg')}}" alt="Movers">
                            </figure>
                        ...
                        <form class="needs-validation" novalidate id="forgetPassword" method="POST" action="{{ route('forgetPassword') }}">
                        {{csrf_field()}}
                        <div id="validation"></div>
                            <div class="form-group is-floating-label required-item">
                              <label class="form-control-placeholder" for="">Email</label>
                              <input type="text" required="" class="form-control field" value="{{ old('email') }}" name="email">
...
================================================== -->
 ...
 $('#validation').html(' <p class="alert alert-danger">{{ Session::get('emailerror') }}</p>');
                $(window).scrollTop(0);
 @endif
  </script>
</body>
