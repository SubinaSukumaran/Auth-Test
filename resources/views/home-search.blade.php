                                       ...
                                       <div class="col-sm-6 mb-3">
                                            <div class="card p-3 radius-16 border">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-3">
                                                        <h5 class="m-0"><a href="#" class="stretched-link text-secondary text-decoration-none" id="total">{{$total_count}}</a></h5>
                                       ...
                                       <div class="col-sm-6 mb-3">
                                            <div class="card p-3 radius-16 border">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-3">
                                                        <h5 class="m-0"><a href="/completedtrips" class="stretched-link text-success text-decoration-none" id="complete">{{$complete_count}}</a></h5>
                                       ...
                                       <div class="col-sm-6 mb-3 mb-sm-0">
                                            <div class="card p-3 radius-16 border">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-3">
                                                        <h5 class="m-0"><a href="/trips" class="stretched-link text-primary text-decoration-none" id="active">{{$active_count}}</a></h5>
                                       ...
                                       <div class="col-sm-6">
                                            <div class="card p-3 radius-16 border">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-3">
                                                        <h5 class="m-0"><a href="/cancelledtrips" class="stretched-link text-danger text-decoration-none" id="cancel">{{$cancel_count}}</a></h5>
